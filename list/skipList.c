//
////////////////////////////////////////////////////////////////////////////////////////
//跳表是种空间来换取时间的算法，通过在每个节点中增加了向前的指针，从而提升查找的效率
//定义：
...
//    (2)每一层都是一个有序的链表
//    (3)最底层的链表包含所有元素
//    (4)如果某元素出现在 Level i 的链表中，则它在 Level i 之下的链表也都会出现
//    (5)每个节点包含两个指针，一个指向同一链表中的下一个元素，一个指向下一层的元素
//跳表的搜索：
//    (1)由高层开始，不成功则经过指向下一层元素的指针到下一层搜索
//跳表的插入：
//    (1)先确定该元素要占据的层数 K（随机选择）
//    (2)然后在 Level 1 ... Level K 各个层的链表都插入元素
//跳表的删除：
//    (1)搜索包含指定元素的高层节点，沿着指向下一层元素的指针删除各节点
//
////////////////////////////////////////////////////////////////////////////////////////
//
/* 
